    ...
    @switch ($indicator)
        @case ('checkbox')
            <span class="absolute end-2 flex items-center justify-center">
                <span
                    class="border-input flex size-4 items-center justify-center rounded-[4px] border transition-colors"
        ...
        @case ('radio')
            <span class="absolute end-2 flex items-center justify-center">
                <span
                    class="border-input flex size-4 items-center justify-center rounded-full border transition-colors"
