...
<template x-teleport="body" wire:ignore>
    <div x-blat-dialog-layer x-show="open" x-cloak x-init="_list = $el" {!! $anchorAttr !!}
        @click.outside="close(false)" @keydown.escape.prevent.stop="close()" @keydown.tab.prevent.stop="close()"
        ...
        :id="$id('blat-listbox')" role="listbox" tabindex="-1" data-slot="select-content"
        :data-state="open ? 'open' : 'closed'" x-transition:enter="transition ease-out duration-150"
