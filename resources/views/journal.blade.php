<x-layouts.app>
    <x-header />
    <main class="w-full pt-20 bg-surface"><div class="flex flex-col w-full">
<!-- Telemetry Strip -->
<div class="w-full bg-surface-container-high px-gutter-desktop py-space-xs">
<div class="max-w-max-content-width mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-space-xs font-label-sm text-label-sm text-on-surface-variant">
<div class="flex items-center gap-space-sm flex-wrap">
<span class="inline-flex items-center gap-space-2xs bg-primary-container/20 text-on-primary-container px-space-xs py-space-2xs rounded text-[11px] font-bold tracking-wider uppercase">
<span class="w-1.5 h-1.5 rounded-full bg-amber-flare animate-ping"></span>
          Live Synoptic Desk
        </span>
<span class="text-on-surface font-medium">Stable pre-monsoon high-pressure ridge active over Khumbu, Annapurna &amp; Manaslu ranges</span>
</div>
<div class="flex items-center gap-space-md text-[11px] text-secondary divide-x divide-outline-variant">
<span class="pr-space-sm flex items-center gap-space-2xs"><span class="material-symbols-outlined text-[14px] text-primary">thermostat</span>Lukla Base: -4°C Clear</span>
<span class="pl-space-sm flex items-center gap-space-2xs"><span class="material-symbols-outlined text-[14px] text-primary">air</span>South Col Wind: 22 kts NW</span>
<span class="pl-space-sm hidden sm:inline-flex items-center gap-space-2xs"><span class="material-symbols-outlined text-[14px] text-primary">schedule</span>Issue No. 48 • Spring 2025</span>
</div>
</div>
</div>
...
<span class="font-badge-caption text-badge-caption tracking-widest text-primary uppercase">Field Dispatches &amp; Himalayan Intelligence</span>
<span class="text-secondary">•</span>
<span class="font-badge-caption text-badge-caption tracking-widest text-secondary uppercase">Neepa Alpine Archives</span>
</div>
...
<div>
<span class="font-badge-caption text-badge-caption uppercase tracking-widest text-primary">Intelligence Repository</span>
<h2 class="font-headline-lg text-headline-lg tracking-tight text-on-surface">Curated Alpine Dispatches</h2>
</div>
...
<span class="font-label-md text-label-md uppercase tracking-wider text-summit-white">Field Notes</span>
</div>
<span class="px-space-xs py-space-2xs rounded bg-surface-container-highest/20 font-badge-caption text-badge-caption text-primary-container">
                Sirdar Wisdom
              </span>
</div>
<!-- Wisdom Item 1 -->
...
<h4 class="font-label-md text-label-md text-summit-white">Sleep with Your Camera &amp; Phone Batteries</h4>
<p class="font-body-sm text-body-sm text-surface-dim">
                Lithium-ion cells lose up to 70% capacity at -15°C overnight. Keep power banks and batteries inside your sleeping bag inner chest pocket.
              </p>
</div>
<!-- Wisdom Item 2 -->
<div class="flex flex-col gap-space-2xs bg-surface-container-highest/10 p-space-md rounded-lg">
...
<p class="font-body-sm text-body-sm text-surface-dim">
                Pair an ultra-thin synthetic liner sock under a high-cushion Merino wool outer sock. Shearing friction occurs between sock layers, never your skin.
              </p>
</div>
<div class="pt-space-xs text-center">
<a class="font-label-sm text-label-sm text-primary-container hover:underline flex items-center justify-center gap-space-2xs" href="#">
...
<span class="font-label-md text-label-md uppercase font-bold text-on-surface">Emergency Field Reference</span>
</div>
<p class="font-body-sm text-body-sm text-on-surface-variant">
              Download our laminated, offline-ready pocket card containing Lake Louise HAPE/HACE symptoms, Gamow bag assembly steps, and helicopter satellite grid coordinates.
            </p>
<a class="inline-flex items-center justify-center gap-space-xs px-space-md py-space-xs rounded bg-surface-container hover:bg-surface-container-high text-on-surface font-label-sm text-label-sm transition-colors" href="#">
...
<a class="px-space-xs py-space-2xs rounded bg-surface-container hover:bg-surface-container-high text-secondary hover:text-on-surface font-body-sm text-body-sm transition-colors" href="#">#EverestBaseCamp</a>
<a class="px-space-xs py-space-2xs rounded bg-surface-container hover:bg-surface-container-high text-secondary hover:text-on-surface font-body-sm text-body-sm transition-colors" href="#">#Acclimatization</a>
<a class="px-space-xs py-space-2xs rounded bg-surface-container hover:bg-surface-container-high text-secondary hover:text-on-surface font-body-sm text-body-sm transition-colors" href="#">#AnnapurnaCircuit</a>
<a class="px-space-xs py-space-2xs rounded bg-surface-container hover:bg-surface-container-high text-secondary hover:text-on-surface font-body-sm text-body-sm transition-colors" href="#">#DiamoxProtocol</a>
<a class="px-space-xs py-space-2xs rounded bg-surface-container hover:bg-surface-container-high text-secondary hover:text-on-surface font-body-sm text-body-sm transition-colors" href="#">#SherpaLineage</a>
<a class="px-space-xs py-space-2xs rounded bg-surface-container hover:bg-surface-container-high text-secondary hover:text-on-surface font-body-sm text-body-sm transition-colors" href="#">#GokyoLakes</a>
<a class="px-space-xs py-space-2xs rounded bg-surface-container hover:bg-surface-container-high text-secondary hover:text-on-surface font-body-sm text-body-sm transition-colors" href="#">#WinterTrekking</a>
...
<svg class="absolute right-0 top-0 h-full w-1/2 opacity-5 pointer-events-none" fill="none" viewbox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
...
<span class="flex items-center gap-space-2xs"><span class="material-symbols-outlined text-[16px] text-primary-container">check_circle</span>Unsubscribe anytime</span>
<span class="flex items-center gap-space-2xs"><span class="material-symbols-outlined text-[16px] text-primary-container">check_circle</span>Dispatched bi-weekly</span>
</div>
</div>
<!-- Subscription Form -->
...
<input class="px-space-md py-3.5 bg-surface-container-lowest/10 text-summit-white placeholder:text-surface-dim/70 rounded font-body-md text-body-md focus:outline-none focus:bg-surface-container-lowest/20 flex-grow" placeholder="Enter your email address" required="" type="email"/>
<button class="px-space-lg py-3.5 bg-primary-container hover:bg-amber-flare text-on-primary-container font-label-md text-label-md uppercase tracking-wider rounded transition-colors whitespace-nowrap" type="submit">
              Receive Dispatches
            </button>
</form>
